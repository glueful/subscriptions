...
namespace Glueful\Extensions\Subscriptions\Tests\Unit\Schema;
...
final class SchemaManifestTest extends TestCase
{
    ...
    public function testVerifierClassConformsToTheManifestContract(): void
    {
        ...
        self::assertSame('glueful/subscriptions', (new $class())->source());
    }

    public function testVerifierCoversEveryRecursivelyDiscoveredMigration(): void
    {
        $mapped = (new SubscriptionsSchemaVerifier())->migrationBasenames();
    ...
    {
        $g = $this->manifest();
        $candidates = ['glueful/subscriptions' => new \Glueful\Extensions\ExtensionCandidate(
            name: 'glueful/subscriptions',
            provider: $g['provider'],
        ...
        self::assertSame([], $result->errors, 'subscriptions must resolve enabled-alone');
    }
